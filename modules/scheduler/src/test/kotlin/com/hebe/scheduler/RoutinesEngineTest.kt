...
class RoutinesEngineTest : StringSpec({
...
private fun insertRoutine(db: Db, params: RoutineParams) {
...
private fun findJob(db: Db, routineId: String): Job? {
    db.dataSource.connection.use { conn ->
        conn.prepareStatement(
...
private fun getNextRunAt(db: Db, routineId: String): Long? {
    db.dataSource.connection.use { conn ->
