...
class StuckJobDetectorTest : StringSpec({
    "run with no stuck jobs returns zero" {
        val db = DbFactory.openInMemory()
        val repo = com.hebe.scheduler.JobRepo(db)
...
private fun insertRunningJob(db: com.hebe.memory.db.Db, id: String, startedAt: Long, payload: String = "{}") {
