...
private fun noopApprovalGate() =
    object : com.hebe.api.ApprovalGate {
        override fun requestIfNeeded(
            ...
            channel: String,
            threadExtId: String?,
        ) = kotlinx.coroutines.flow.flowOf(com.hebe.api.ApprovalStatus.Denied)
...
private fun noopObserver() =
    object : com.hebe.api.Observer {
        override fun event(e: com.hebe.api.ObserverEvent) {}

        override fun span(
            name: String,
            attrs: Map<String, Any>,
        ): com.hebe.api.Span = noopSpan()
    }

private fun noopSpan() =
    object : com.hebe.api.Span {
...
private fun createFakeDispatcher(memory: com.hebe.api.MemoryStore): com.hebe.tools.dispatch.ToolDispatcher =
    com.hebe.tools.dispatch.ToolDispatcher(
        registry =
...
private fun noopCostGuard() =
    mockk<com.hebe.core.cost.CostGuard>(relaxed = true).also {
...
private fun noopCompactor(): com.hebe.core.compaction.PreemptivePruner {
    ...
    every { compactorLlm.capabilities() } returns
        com.hebe.api.ProviderCapabilities(streaming = true, toolUse = false, multimodal = false, maxContextTokens = 128_000)
