...
class CronParserTest : StringSpec({
    val utc = TimeZone.UTC

    @Suppress("LongParameterList")
    fun instant(year: Int, month: Int, day: Int, hour: Int, min: Int, sec: Int = 0): Instant =
        kotlinx.datetime.LocalDateTime(year, month, day, hour, min, sec).toInstant(utc)
