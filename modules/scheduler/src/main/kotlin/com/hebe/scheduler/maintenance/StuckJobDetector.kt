...
import com.hebe.scheduler.JobRepo
...
class StuckJobDetector(
    ...
    private fun markJobStuck(job: StuckJobRow, nowMs: Long) {
    ...
    private fun insertRetry(job: StuckJobRow, nowMs: Long) {
    ...
    private fun mergeStuckResult(existing: String): String {
        return try {
            val elem = kotlinx.serialization.json.Json.parseToJsonElement(existing)
