...
class HebePluginClassLoader(
    ...
    override fun loadClass(
        ...
        if (name.startsWith("com.hebe.") &&
            !name.startsWith("com.hebe.api.") &&
            !name.startsWith("com.hebe.plugin.api.")
        ) {
            throw ClassNotFoundException("Plugin cannot access host-private class: $name")
        }
        if (name.startsWith("com.hebe.api.") || name.startsWith("com.hebe.plugin.api.")) {
