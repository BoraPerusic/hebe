...
class Gateway {
    ...
    private var channelHealthProvider: () -> List<Pair<String, com.hebe.api.ChannelHealth>> = { emptyList() }
    private var llmHealthProvider: () -> Pair<String, Boolean> = { "" to false }
    private var serverStartMs: Long = 0L

    fun setChannelHealthProvider(provider: () -> List<Pair<String, com.hebe.api.ChannelHealth>>) {
