...
class HebeAgentTest {
    ...
    @Test
    fun `user input returns Response`() = runTest {
        val llm =
            MockLlmProvider
                .builder()
                .turn {
    ...
    @Test
    fun `quit command returns Stopped`() = runTest {
    ...
    @Test
    fun `status command returns status`() = runTest {
        val llm = MockLlmProvider.builder().build()
        val agent = makeAgent(llm)
    ...
    @Test
    fun `compact command runs compaction`() = runTest {
        val llm = MockLlmProvider.builder().build()
        val agent = makeAgent(llm)
    ...
    @Test
    fun `approval command resolves gate`() = runTest {
        val llm = MockLlmProvider.builder().build()
        val agent = makeAgent(llm)
    ...
    @Test
    fun `authMode command stores secret`() = runTest {
        val llm = MockLlmProvider.builder().build()
        val agent = makeAgent(llm)
        val meta =
