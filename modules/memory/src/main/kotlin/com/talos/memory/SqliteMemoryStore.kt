package com.talos.memory

import com.talos.api.ChatRole
import com.talos.api.ConversationMessage
import com.talos.api.MemoryCategory
import com.talos.api.MemoryHit
import com.talos.api.MemoryScope
import com.talos.api.MemorySnapshot
import com.talos.api.MemoryStore
import com.talos.api.Observer
import com.talos.api.ObserverEvent
import com.talos.api.TalosException
import com.talos.memory.db.Db
import com.talos.memory.embeddings.EmbeddingProvider
import com.talos.memory.hygiene.HygieneResult
import com.talos.memory.hygiene.HygieneScanner
import com.talos.memory.indexer.Indexer
import com.talos.memory.search.Searcher
import com.talos.memory.workspace.WorkspaceFs
import com.talos.memory.workspace.WorkspacePath
...
class SqliteMemoryStore(
    ...
    override suspend fun appendDoc(
        ...
        when (verdict) {
            is HygieneResult.Reject -> throw TalosException.Memory("rejected: ${verdict.findings.first().rule}")
