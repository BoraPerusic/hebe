...
class LogbackObserver(
    ...
    private val logger = KotlinLogging.logger("com.hebe.observability")
    ...
    override fun event(e: ObserverEvent) {
        ...
        val eventLog =
            LogEvent(
                ...
                logger = "com.hebe.observability.Observer",
                message = e.toString(),
                sessionId = sessionId,
                turnId = turnId,
                tool = tool,
        ...
        try {
            ...
            MDC.put("logger", "com.hebe.observability.Observer")
    ...
    override fun span(
        ...
        val event =
            LogEvent(
                ...
                logger = "com.hebe.observability.Span",
